...
3.	Deverá permitir o login do usuário: após a realização de seu cadastro, o usuário terá o livre acesso ao seu login em nosso sistema.
4.	Deverá ser disponibilizado área para envio dos trabalhos: o aluno terá acesso para envio do documento de trabalho.
5.	Deverá ser disponibilizado área para download do documento e envio: o professor terá acesso a baixar o documento enviado pelo aluno para avaliação e devolutiva de feedback.
